...
description: 'HYPIQ prediction protocol built on Hyperliquid infrastructure'
icon: 'layers'
---

# Platform Overview

HYPIQ is the first decentralized prediction protocol built natively on Hyperliquid, enabling real-time speculation on trading outcomes with transparent, on-chain settlement.
...
<CardGroup cols={2}>
  ...
  <Card title="Outcome Prediction" icon="target">
